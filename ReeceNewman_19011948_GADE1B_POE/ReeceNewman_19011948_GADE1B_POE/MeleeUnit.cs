...
namespace ReeceNewman_19011948_GADE1B_POE
{
    class MeleeUnit : Unit
    {
        ...
        public MeleeUnit(int xPos, int yPos, int health, int speed, int range, char symbol, int attack, int faction) : base(xPos, yPos, health, faction, speed, attack, range, symbol)
        {
